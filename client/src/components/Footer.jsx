...
const Footer = () => {
  ...
  return (
    <div>
      <footer class="relative inset-x-0 bg-blue-100/80 font-sans dark:bg-gray-900 bottom-0">
        <div class="container px-6 pt-6 mx-auto">
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div class="sm:col-span-2">
              <h1 class="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl dark:text-white">
                Subscribe our bookmark store to get an update.
              </h1>
          ...
          <p class="font-sans text-white pt-4 text-start md:text-center md:text-lg md:p-4">
            © 2024 Markify. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
